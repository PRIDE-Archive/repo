...
public class InstrumentPersistenceTest {
  ...
  private static final String ANOTHER_INSTRUMENT_MODEL_ACCESSION =
      "Instrument Model Cv Param Accession";
  ...
  private static final String ANOTHER_INSTRUMENT_SOURCE_INSTRUMENT_COMPONENT_ACCESSION =
      "another source";
  ...
  private static final String ANOTHER_INSTRUMENT_ANALYZER_INSTRUMENT_COMPONENT_ACCESSION =
      "analyzer3";
  ...
  private static final String ANOTHER_INSTRUMENT_DETECTOR_INSTRUMENT_COMPONENT_ACCESSION =
      "another detector";
  private static final String ANOTHER_INSTRUMENT_DETECTOR_INSTRUMENT_COMPONENT_LABEL = "MS";
  private static final String ANOTHER_INSTRUMENT_SOURCE_INSTRUMENT_COMPONENT_VALUE =
      "source component value";
  private static final String ANOTHER_INSTRUMENT_ANALYZER_INSTRUMENT_COMPONENT_VALUE =
      "analyzer component value";
  private static final String ANOTHER_INSTRUMENT_DETECTOR_INSTRUMENT_COMPONENT_VALUE =
      "detector component value";
  ...
  public void testGetByAssayId() throws Exception {
    ...
    for (Instrument theInstrument : instruments) {
      ...
      if (containsInstrument1InDb) checkIsInstrument1InDb(theInstrument);
    }
  ...
  public void testSaveAndGet() throws Exception {
    ...
    sourceInstrumentComponentCvParamCvParam.setAccession(
        ANOTHER_INSTRUMENT_SOURCE_INSTRUMENT_COMPONENT_ACCESSION);
    sourceInstrumentComponentCvParamCvParam.setCvLabel(
        ANOTHER_INSTRUMENT_SOURCE_INSTRUMENT_COMPONENT_LABEL);
    sourceInstrumentComponentCvParamCvParam.setName(
        ANOTHER_INSTRUMENT_SOURCE_INSTRUMENT_COMPONENT_NAME);
    ...
    InstrumentComponentCvParam analyzerInstrumentComponentCvParam =
        new InstrumentComponentCvParam();
    analyzerInstrumentComponentCvParam.setInstrumentComponent(analyzerInstrumentComponent);
    analyzerInstrumentComponentCvParam.setValue(
        ANOTHER_INSTRUMENT_ANALYZER_INSTRUMENT_COMPONENT_VALUE);

    CvParam analyzerInstrumentComponentCvParamCvParam = new CvParam();
    analyzerInstrumentComponentCvParamCvParam.setAccession(
        ANOTHER_INSTRUMENT_ANALYZER_INSTRUMENT_COMPONENT_ACCESSION);
    analyzerInstrumentComponentCvParamCvParam.setCvLabel(
        ANOTHER_INSTRUMENT_ANALYZER_INSTRUMENT_COMPONENT_LABEL);
    analyzerInstrumentComponentCvParamCvParam.setName(
        ANOTHER_INSTRUMENT_ANALYZER_INSTRUMENT_COMPONENT_NAME);
    ...
    InstrumentComponentCvParam detectorInstrumentComponentCvParam =
        new InstrumentComponentCvParam();
    detectorInstrumentComponentCvParam.setInstrumentComponent(detectorInstrumentComponent);
    detectorInstrumentComponentCvParam.setValue(
        ANOTHER_INSTRUMENT_DETECTOR_INSTRUMENT_COMPONENT_VALUE);

    CvParam detectorInstrumentComponentCvParamCvParam = new CvParam();
    detectorInstrumentComponentCvParamCvParam.setAccession(
        ANOTHER_INSTRUMENT_DETECTOR_INSTRUMENT_COMPONENT_ACCESSION);
    detectorInstrumentComponentCvParamCvParam.setCvLabel(
        ANOTHER_INSTRUMENT_DETECTOR_INSTRUMENT_COMPONENT_LABEL);
    detectorInstrumentComponentCvParamCvParam.setName(
        ANOTHER_INSTRUMENT_DETECTOR_INSTRUMENT_COMPONENT_NAME);
  ...
  private void checkIsInstrument1InDb(Instrument instrument) {
    ...
    assertThat(
        sourceInstrumentComponent.getOrder(), is(INSTRUMENT_1_SOURCE_INSTRUMENT_COMPONENT_ORDER));
    InstrumentComponentCvParam instrumentSourceComponentCvParam =
        (InstrumentComponentCvParam) sourceInstrumentComponent.getParams().iterator().next();
    ...
    assertThat(
        sourceCvParam.getAccession(), is(INSTRUMENT_1_SOURCE_INSTRUMENT_COMPONENT_ACCESSION));
    ...
    AnalyzerInstrumentComponent analyzerInstrumentComponent =
        instrument.getAnalyzers().iterator().next();
    assertNotNull(analyzerInstrumentComponent);
    assertThat(
        analyzerInstrumentComponent.getId(), is(INSTRUMENT_1_ANALYZER_INSTRUMENT_COMPONENT_ID));
    assertThat(
        analyzerInstrumentComponent.getOrder(),
        is(INSTRUMENT_1_ANALYZER_INSTRUMENT_COMPONENT_ORDER));
    Iterator<ParamProvider> params = analyzerInstrumentComponent.getParams().iterator();
    InstrumentComponentCvParam instrumentAnalyzer1ComponentCvParam =
        (InstrumentComponentCvParam) params.next();
    ...
    assertThat(
        analyzer1CvParam.getAccession(), is(INSTRUMENT_1_ANALYZER1_INSTRUMENT_COMPONENT_ACCESSION));
    assertThat(
        analyzer1CvParam.getCvLabel(), is(INSTRUMENT_1_ANALYZER1_INSTRUMENT_COMPONENT_LABEL));
    InstrumentComponentCvParam instrumentAnalyzer2ComponentCvParam =
        (InstrumentComponentCvParam) params.next();
    ...
    assertThat(
        analyzer2CvParam.getAccession(), is(INSTRUMENT_1_ANALYZER2_INSTRUMENT_COMPONENT_ACCESSION));
    assertThat(
        analyzer2CvParam.getCvLabel(), is(INSTRUMENT_1_ANALYZER2_INSTRUMENT_COMPONENT_LABEL));

    DetectorInstrumentComponent detectorInstrumentComponent =
        instrument.getDetectors().iterator().next();
    assertNotNull(detectorInstrumentComponent);
    assertThat(
        detectorInstrumentComponent.getId(), is(INSTRUMENT_1_DETECTOR_INSTRUMENT_COMPONENT_ID));
    assertThat(
        detectorInstrumentComponent.getOrder(),
        is(INSTRUMENT_1_DETECTOR_INSTRUMENT_COMPONENT_ORDER));
    InstrumentComponentCvParam instrumentDetectorComponentCvParam =
        (InstrumentComponentCvParam) detectorInstrumentComponent.getParams().iterator().next();
    ...
    assertThat(
        detectorCvParam.getAccession(), is(INSTRUMENT_1_DETECTOR_INSTRUMENT_COMPONENT_ACCESSION));
  ...
  private void checkIsAnotherInstrumentInDb(Instrument instrument) {
    ...
    assertNotNull(sourceInstrumentComponent);
    assertThat(
        sourceInstrumentComponent.getOrder(),
        is(ANOTHER_INSTRUMENT_SOURCE_INSTRUMENT_COMPONENT_ORDER));
    InstrumentComponentCvParam instrumentSourceComponentCvParam =
        (InstrumentComponentCvParam) sourceInstrumentComponent.getParams().iterator().next();
    assertNotNull(instrumentSourceComponentCvParam);
    CvParam sourceCvParam = instrumentSourceComponentCvParam.getCvParam();
    ...
    assertThat(
        sourceCvParam.getAccession(), is(ANOTHER_INSTRUMENT_SOURCE_INSTRUMENT_COMPONENT_ACCESSION));
    assertThat(
        sourceCvParam.getCvLabel(), is(ANOTHER_INSTRUMENT_SOURCE_INSTRUMENT_COMPONENT_LABEL));
    ...
    assertThat(
        analyzerInstrumentComponent.getOrder(),
        is(ANOTHER_INSTRUMENT_ANALYZER_INSTRUMENT_COMPONENT_ORDER));
    Iterator<ParamProvider> params = analyzerInstrumentComponent.getParams().iterator();
    InstrumentComponentCvParam instrumentAnalyzer1ComponentCvParam =
        (InstrumentComponentCvParam) params.next();
    assertNotNull(instrumentAnalyzer1ComponentCvParam);
    ...
    assertNotNull(analyzer1CvParam);
    assertThat(
        analyzer1CvParam.getName(), is(ANOTHER_INSTRUMENT_ANALYZER_INSTRUMENT_COMPONENT_NAME));
    assertThat(
        analyzer1CvParam.getAccession(),
        is(ANOTHER_INSTRUMENT_ANALYZER_INSTRUMENT_COMPONENT_ACCESSION));
    assertThat(
        analyzer1CvParam.getCvLabel(), is(ANOTHER_INSTRUMENT_ANALYZER_INSTRUMENT_COMPONENT_LABEL));
    ...
    assertThat(
        detectorInstrumentComponent.getOrder(),
        is(ANOTHER_INSTRUMENT_DETECTOR_INSTRUMENT_COMPONENT_ORDER));
    InstrumentComponentCvParam instrumentDetectorComponentCvParam =
        (InstrumentComponentCvParam) detectorInstrumentComponent.getParams().iterator().next();
    assertNotNull(instrumentDetectorComponentCvParam);
    CvParam detectorCvParam = instrumentDetectorComponentCvParam.getCvParam();
    assertNotNull(detectorCvParam);
    assertThat(
        detectorCvParam.getName(), is(ANOTHER_INSTRUMENT_DETECTOR_INSTRUMENT_COMPONENT_NAME));
    assertThat(
        detectorCvParam.getAccession(),
        is(ANOTHER_INSTRUMENT_DETECTOR_INSTRUMENT_COMPONENT_ACCESSION));
    assertThat(
        detectorCvParam.getCvLabel(), is(ANOTHER_INSTRUMENT_DETECTOR_INSTRUMENT_COMPONENT_LABEL));
  }
}
