 ...
 * @author Rui Wang
 * @version $Id$
 * @see uk.ac.ebi.pride.archive.repo.user.service.UserSummary
...
public class UserSummaryValidator implements Validator {
  ...
  public static final String ACCEPTED_TERMS_ERROR_MESSAGE =
      "Must accept Terms of Usage - Privacy Notice";
  ...
  public void validateContactDetails(Object target, Errors errors) {
    ...
    ValidationUtils.rejectIfEmptyOrWhitespace(
        errors, "acceptedTermsOfUse", "required", ACCEPTED_TERMS_ERROR_MESSAGE);
    rejectNotAcceptedTerms(errors, ACCEPTED_TERMS_ERROR_MESSAGE);
  }
  ...
  protected void rejectNotAcceptedTerms(Errors errors, String errorMessage) {
    Object value = errors.getFieldValue("acceptedTermsOfUse");
    if (value != null) {
      boolean acceptedTerms = Boolean.valueOf(value.toString());
      if (!acceptedTerms) {
        errors.rejectValue("acceptedTermsOfUse", "required", null, errorMessage);
      }
    }
  }
