...
public class Assay implements AssayProvider {
    ...
    public boolean equals(Object o) {
        ...
        if (assayGroupCvParams != null ? !assayGroupCvParams.equals(assay.assayGroupCvParams) : assay.assayGroupCvParams != null)
            return false;
        if (assayGroupUserParams != null ? !assayGroupUserParams.equals(assay.assayGroupUserParams) : assay.assayGroupUserParams != null)
            return false;
        if (contacts != null ? !contacts.equals(assay.contacts) : assay.contacts != null) return false;
        if (experimentalFactor != null ? !experimentalFactor.equals(assay.experimentalFactor) : assay.experimentalFactor != null)
            return false;
        if (instruments != null ? !instruments.equals(assay.instruments) : assay.instruments != null) return false;
        if (ptms != null ? !ptms.equals(assay.ptms) : assay.ptms != null) return false;
        if (quantificationMethods != null ? !quantificationMethods.equals(assay.quantificationMethods) : assay.quantificationMethods != null)
            return false;
