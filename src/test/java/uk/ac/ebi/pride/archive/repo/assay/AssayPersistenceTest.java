...
public class AssayPersistenceTest {
  ...
  private static final String ANOTHER_ASSAY_EXPERIMENTAL_FACTOR =
  ...
  public static void checkIsInstrument1InDb(Instrument instrument) {
    ...
    assertThat(
        analyzerInstrumentComponent.getOrder(), is(ASSAY_1_ANALYZER_INSTRUMENT_COMPONENT_ORDER));
    ...
    assertThat(
        analyzer1CvParam.getAccession(), is(ASSAY_1_ANALYZER1_INSTRUMENT_COMPONENT_ACCESSION));
    ...
    assertThat(
        analyzer2CvParam.getAccession(), is(ASSAY_1_ANALYZER2_INSTRUMENT_COMPONENT_ACCESSION));
    ...
    assertThat(
        detectorInstrumentComponent.getOrder(), is(ASSAY_1_DETECTOR_INSTRUMENT_COMPONENT_ORDER));
  ...
  public void testGetByProjectId() throws Exception {
    ...
    for (Assay assay : assays) {
      if (assay.getId() == ASSAY_1_ID) checkIsAssay1InDb(assay);
      else checkIsAssay2InDb(assay);
    }
  }
  ...
  public void testSaveAndGet() throws Exception {
    ...
    AssayQuantificationMethodCvParam assayQuantificationMethod =
        new AssayQuantificationMethodCvParam();
  ...
  private void checkOtherQuantificationMethods(Assay assay) {
    ...
    Collection<AssayQuantificationMethodCvParam> quantificationMethods =
        assay.getQuantificationMethods();
