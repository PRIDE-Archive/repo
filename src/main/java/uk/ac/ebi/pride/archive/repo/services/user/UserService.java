...
public interface UserService {
     ...
     * @return true indicates emails already in use, false means email can be used to create
     * a new user
     */
    boolean isEmailedInUse(String email) throws UserAccessException;

    /**
     * Attempt to login as an already registered user
     * The password should be passed in as plain text
     */
