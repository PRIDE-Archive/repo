...
public class UserPersistenceTest {
  ...
  public void testSaveAndGet() throws Exception {
    ...
    User other = userRepository.findOne(user.getId());
  ...
  private void checkUser1InDb(User user) {
    ...
    assertThat(user.getAcceptedTermsOfUse(), is(1));
    assertThat(df.format(user.getAcceptedTermsOfUseAt()), is(USER_1_UPDATE_AT));
