 ...
 *
 * NOTE: this implementation is based on Spring framework's validator interface
 *
 * @author Rui Wang
 * @version $Id$
 * @see uk.ac.ebi.pride.archive.repo.user.service.UserSummary
 *
 * todo: refactor to make error messages customizable
...
public class UserSummaryValidator implements Validator {
    ...
    public void validateContactDetails(Object target, Errors errors) {
        ...
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "title", "required", USER_TITLE_ERROR_MESSAGE);
    ...
    public void validatePassword(Object target, Errors errors) {
        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "password", "required", PASSWORD_ERROR_MESSAGE);
    }
